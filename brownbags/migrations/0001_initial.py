    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, default=None, max_length=256, null=True, verbose_name='description')),
                ('addr_sel', models.CharField(blank=True, default=None, max_length=256, null=True, verbose_name='addr_sel')),
                ('addr', models.CharField(blank=True, default=None, max_length=256, null=True, verbose_name='addr')),
                ...
                ('takeaway_note', models.TextField(blank=True, default='', max_length=1024, verbose_name='takeaway_note')),
                ...
                ('phone', models.CharField(blank=True, default=None, max_length=256, null=True, verbose_name='phone')),
                ...
                ('website', models.CharField(blank=True, default=None, max_length=1024, null=True, verbose_name='website')),
                ('twitter', models.CharField(blank=True, default=None, max_length=256, null=True, verbose_name='twitter')),
                ('facebook', models.CharField(blank=True, default=None, max_length=256, null=True, verbose_name='facebook')),
                ('instagram', models.CharField(blank=True, default=None, max_length=256, null=True, verbose_name='instagram')),
                ('line', models.CharField(blank=True, default=None, max_length=256, null=True, verbose_name='line')),
                ('sns_other', models.CharField(blank=True, default=None, max_length=256, null=True, verbose_name='sns_other')),
                ('transportation', models.TextField(blank=True, default='', max_length=512, verbose_name='transportation')),
                ...
                ('expired_shop_date', models.DateTimeField(blank=True, null=True)),
                ('closes_shop_date', models.DateTimeField(blank=True, null=True)),
                ('soldout_takeaway_date', models.DateTimeField(blank=True, null=True)),
                ('soldout_delivery_date', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_data', models.ImageField(blank=True, default='/static/brownbags/images/none.png', null=True, upload_to=brownbags.models.get_image_path, validators=[brownbags.validators.validate_file_extension], verbose_name='画像')),
                ('image_data_class', models.IntegerField(choices=[(0, 'その他'), (1, '店舗'), (2, 'テイクアウト'), (-1, '---')], default=-1, verbose_name='クラス')),
                ('image_data_order', models.IntegerField(default=0, verbose_name='順番')),
